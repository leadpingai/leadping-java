package ai.leadping.openapi.sms.send;

import ai.leadping.openapi.models.ProblemDetails;
import ai.leadping.openapi.models.SendSmsRequest;
import ai.leadping.openapi.models.SmsResponse;
...
public class SendRequestBuilder extends BaseRequestBuilder {
    ...
    public SendRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sms/send", pathParameters);
    }
    /**
     * Instantiates a new {@link SendRequestBuilder} and sets the default values.
    ...
    public SmsResponse post(@jakarta.annotation.Nonnull final SendSmsRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public SmsResponse post(@jakarta.annotation.Nonnull final SendSmsRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SendSmsRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final SendSmsRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
