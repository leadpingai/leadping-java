package ai.leadping.openapi.phonenumbers.all.organization;
...
public class OrganizationRequestBuilder extends BaseRequestBuilder {
    ...
    public OrganizationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/phone-numbers/all/organization", pathParameters);
    }
    /**
     * Instantiates a new {@link OrganizationRequestBuilder} and sets the default values.
    ...
    public OrganizationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/phone-numbers/all/organization", rawUrl);
    }
    /**
    ...
    public PagedResultOfPhoneNumberTableRow post(@jakarta.annotation.Nonnull final RequestDataOptions body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PagedResultOfPhoneNumberTableRow post(@jakarta.annotation.Nonnull final RequestDataOptions body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
