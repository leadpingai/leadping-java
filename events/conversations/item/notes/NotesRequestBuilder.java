package ai.leadping.openapi.events.conversations.item.notes;

import ai.leadping.openapi.models.CreateNoteRequest;
...
public class NotesRequestBuilder extends BaseRequestBuilder {
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/events/conversations/{conversationId}/notes", pathParameters);
    }
    /**
     * Instantiates a new {@link NotesRequestBuilder} and sets the default values.
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/events/conversations/{conversationId}/notes", rawUrl);
    }
    /**
    ...
    public EventTableRow post(@jakarta.annotation.Nonnull final CreateNoteRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public EventTableRow post(@jakarta.annotation.Nonnull final CreateNoteRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateNoteRequest body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final CreateNoteRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
