package ai.leadping.openapi.sources.item.credentials.rotate;
...
public class RotateRequestBuilder extends BaseRequestBuilder {
    ...
    public RotateRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sources/{id}/credentials/rotate", pathParameters);
    }
    /**
     * Instantiates a new {@link RotateRequestBuilder} and sets the default values.
    ...
    public RotateRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/sources/{id}/credentials/rotate", rawUrl);
    }
    /**
    ...
    public SourceCredentialIssueResponse post() {
        return post(null);
    }
    /**
     * Invalidates the current credential and returns the replacement secret once. Only its hash and short preview are retained.
     ...
     */
    @jakarta.annotation.Nullable
    public SourceCredentialIssueResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
