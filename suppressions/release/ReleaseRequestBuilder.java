package ai.leadping.openapi.suppressions.release;
...
public class ReleaseRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link ReleaseRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ReleaseRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/suppressions/release", pathParameters);
    }
    /**
     * Instantiates a new {@link ReleaseRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public ReleaseRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param rawUrl The raw URL to use for the request builder.
     * @return a {@link ReleaseRequestBuilder}
     */
    @jakarta.annotation.Nonnull
    public ReleaseRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
        Objects.requireNonNull(rawUrl);
        return new ReleaseRequestBuilder(rawUrl, requestAdapter);
    }
    /**
