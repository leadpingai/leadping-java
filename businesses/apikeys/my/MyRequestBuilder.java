package ai.leadping.openapi.businesses.apikeys.my;

import ai.leadping.openapi.models.PagedResultOfBusinessTableRow;
...
public class MyRequestBuilder extends BaseRequestBuilder {
    ...
    public MyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/businesses/api-keys/my", pathParameters);
    }
    /**
     * Instantiates a new {@link MyRequestBuilder} and sets the default values.
    ...
    public PagedResultOfBusinessTableRow post(@jakarta.annotation.Nonnull final RequestDataOptions body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PagedResultOfBusinessTableRow post(@jakarta.annotation.Nonnull final RequestDataOptions body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
