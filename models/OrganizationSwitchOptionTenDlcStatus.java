...
public enum OrganizationSwitchOptionTenDlcStatus implements ValuedEnum {
    ...
    OrganizationSwitchOptionTenDlcStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationSwitchOptionTenDlcStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
