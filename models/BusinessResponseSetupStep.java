...
public enum BusinessResponseSetupStep implements ValuedEnum {
    ...
    BusinessResponseSetupStep(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static BusinessResponseSetupStep forValue(@jakarta.annotation.Nonnull final String searchValue) {
