...
public class PagedResultOfSuppressionEntryResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<SuppressionEntryResponse> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfSuppressionEntryResponse} and sets the default values.
     */
    public PagedResultOfSuppressionEntryResponse() {
    ...
    public static PagedResultOfSuppressionEntryResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfSuppressionEntryResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(SuppressionEntryResponse::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<SuppressionEntryResponse>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<SuppressionEntryResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<SuppressionEntryResponse> value) {
        this.items = value;
    }
    /**
