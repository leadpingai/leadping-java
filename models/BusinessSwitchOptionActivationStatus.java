...
public enum BusinessSwitchOptionActivationStatus implements ValuedEnum {
    ...
    BusinessSwitchOptionActivationStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static BusinessSwitchOptionActivationStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
