...
public enum InitiateCallRequestOutboundPriority implements ValuedEnum {
    ...
    InitiateCallRequestOutboundPriority(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static InitiateCallRequestOutboundPriority forValue(@jakarta.annotation.Nonnull final String searchValue) {
