...
public class PhoneNumberStatusResponseSmsWarmup extends SmsWarmupStatusResponse implements Parsable {
     ...
     */
    public PhoneNumberStatusResponseSmsWarmup() {
        super();
    }
    /**
    ...
    public static PhoneNumberStatusResponseSmsWarmup createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PhoneNumberStatusResponseSmsWarmup();
    }
    /**
