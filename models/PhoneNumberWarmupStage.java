...
public enum PhoneNumberWarmupStage implements ValuedEnum {
    Stage0("Stage 0"),
    Stage1("Stage 1"),
    Stage2("Stage 2"),
    Stage3("Stage 3"),
    ...
    PhoneNumberWarmupStage(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static PhoneNumberWarmupStage forValue(@jakarta.annotation.Nonnull final String searchValue) {
