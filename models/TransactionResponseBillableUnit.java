...
public enum TransactionResponseBillableUnit implements ValuedEnum {
    ...
    TransactionResponseBillableUnit(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static TransactionResponseBillableUnit forValue(@jakarta.annotation.Nonnull final String searchValue) {
