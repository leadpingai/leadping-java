...
public class TenDlcNotesRequest implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link TenDlcNotesRequest} and sets the default values.
     */
    public TenDlcNotesRequest() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link TenDlcNotesRequest}
     */
    @jakarta.annotation.Nonnull
    public static TenDlcNotesRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new TenDlcNotesRequest();
    }
    /**
