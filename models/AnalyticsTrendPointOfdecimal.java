...
public class AnalyticsTrendPointOfdecimal implements AdditionalDataHolder, Parsable {
     ...
     */
    public AnalyticsTrendPointOfdecimal() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link AnalyticsTrendPointOfdecimal}
     */
    @jakarta.annotation.Nonnull
    public static AnalyticsTrendPointOfdecimal createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
