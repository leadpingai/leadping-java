...
public enum OrganizationBillingStatePendingBillingPlan implements ValuedEnum {
    ...
    OrganizationBillingStatePendingBillingPlan(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationBillingStatePendingBillingPlan forValue(@jakarta.annotation.Nonnull final String searchValue) {
