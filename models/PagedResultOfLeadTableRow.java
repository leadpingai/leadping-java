...
public class PagedResultOfLeadTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<LeadTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfLeadTableRow} and sets the default values.
     */
    public PagedResultOfLeadTableRow() {
    ...
    public static PagedResultOfLeadTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfLeadTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(LeadTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<LeadTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<LeadTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<LeadTableRow> value) {
        this.items = value;
    }
    /**
