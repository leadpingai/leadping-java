...
public enum OrganizationTableRowWebsiteStatus implements ValuedEnum {
    ...
    OrganizationTableRowWebsiteStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationTableRowWebsiteStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
