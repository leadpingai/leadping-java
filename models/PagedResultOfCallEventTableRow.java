...
public class PagedResultOfCallEventTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<CallEventTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfCallEventTableRow} and sets the default values.
     */
    public PagedResultOfCallEventTableRow() {
    ...
    public static PagedResultOfCallEventTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(CallEventTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<CallEventTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<CallEventTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<CallEventTableRow> value) {
        this.items = value;
    }
    /**
