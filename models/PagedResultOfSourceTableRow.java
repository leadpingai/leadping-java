...
public class PagedResultOfSourceTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<SourceTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfSourceTableRow} and sets the default values.
     */
    public PagedResultOfSourceTableRow() {
    ...
    public static PagedResultOfSourceTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfSourceTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(SourceTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<SourceTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<SourceTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<SourceTableRow> value) {
        this.items = value;
    }
    /**
