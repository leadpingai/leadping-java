...
public enum SendSmsRequestSelectionReason implements ValuedEnum {
    ...
    SendSmsRequestSelectionReason(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static SendSmsRequestSelectionReason forValue(@jakarta.annotation.Nonnull final String searchValue) {
