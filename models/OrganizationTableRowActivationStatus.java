...
public enum OrganizationTableRowActivationStatus implements ValuedEnum {
    ...
    OrganizationTableRowActivationStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationTableRowActivationStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
