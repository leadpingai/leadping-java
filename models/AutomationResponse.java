...
public class AutomationResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AutomationResponse} and sets the default values.
     */
    ...
    public static AutomationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nullable
    public AutomationResponseUser getUser() {
        return this.user;
    }
    /**
