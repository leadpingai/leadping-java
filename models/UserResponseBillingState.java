...
public class UserResponseBillingState extends BusinessBillingState implements Parsable {
     ...
     */
    public UserResponseBillingState() {
        super();
    }
    /**
    ...
    public static UserResponseBillingState createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UserResponseBillingState();
    }
    /**
