...
public enum OrganizationResponseSetupStep implements ValuedEnum {
    ...
    OrganizationResponseSetupStep(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationResponseSetupStep forValue(@jakarta.annotation.Nonnull final String searchValue) {
