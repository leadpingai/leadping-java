...
public enum AutomationSmsDeliveryRecordStatus implements ValuedEnum {
    Draft("draft"),
    Scheduled("scheduled"),
    Queued("queued"),
    Sending("sending"),
    ...
    AutomationSmsDeliveryRecordStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static AutomationSmsDeliveryRecordStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
