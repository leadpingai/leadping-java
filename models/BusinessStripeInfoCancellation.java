...
public class BusinessStripeInfoCancellation extends UserSubscriptionCancellationInfo implements Parsable {
     ...
     */
    public BusinessStripeInfoCancellation() {
        super();
    }
    /**
    ...
    public static BusinessStripeInfoCancellation createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BusinessStripeInfoCancellation();
    }
    /**
