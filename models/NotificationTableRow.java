...
public class NotificationTableRow implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link NotificationTableRow} and sets the default values.
     */
    public NotificationTableRow() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link NotificationTableRow}
     */
    @jakarta.annotation.Nonnull
    public static NotificationTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
