...
public enum SmsResponseSelectionReason implements ValuedEnum {
    ...
    SmsResponseSelectionReason(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static SmsResponseSelectionReason forValue(@jakarta.annotation.Nonnull final String searchValue) {
