...
public class OrganizationResponse implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link OrganizationResponse} and sets the default values.
     */
    ...
    public static OrganizationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseActivation getActivation() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseAddress getAddress() {
        return this.address;
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseBillingAddress getBillingAddress() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseBillingPlan getBillingPlan() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseBillingState getBillingState() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseCompliancePolicy getCompliancePolicy() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseEinDocument getEinDocument() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billingState", (n) -> { this.setBillingState(n.getObjectValue(OrganizationResponseBillingState::createFromDiscriminatorValue)); });
        deserializerMap.put("billingTaxId", (n) -> { this.setBillingTaxId(n.getStringValue()); });
        deserializerMap.put("compliancePolicy", (n) -> { this.setCompliancePolicy(n.getObjectValue(OrganizationResponseCompliancePolicy::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("setupStatus", (n) -> { this.setSetupStatus(n.getEnumValue(OrganizationResponseSetupStatus::forValue)); });
        deserializerMap.put("setupStep", (n) -> { this.setSetupStep(n.getEnumValue(OrganizationResponseSetupStep::forValue)); });
        deserializerMap.put("site", (n) -> { this.setSite(n.getObjectValue(OrganizationResponseSite::createFromDiscriminatorValue)); });
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(OrganizationResponseStatus::forValue)); });
        deserializerMap.put("subscriptionStatus", (n) -> { this.setSubscriptionStatus(n.getEnumValue(OrganizationResponseSubscriptionStatus::forValue)); });
        deserializerMap.put("user", (n) -> { this.setUser(n.getObjectValue(OrganizationResponseUser::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseSetupStatus getSetupStatus() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseSetupStep getSetupStep() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseSite getSite() {
        return this.site;
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseStatus getStatus() {
        return this.status;
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseSubscriptionStatus getSubscriptionStatus() {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponseUser getUser() {
        return this.user;
    }
    /**
