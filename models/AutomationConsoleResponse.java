...
public class AutomationConsoleResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AutomationConsoleResponse} and sets the default values.
     */
    public AutomationConsoleResponse() {
    ...
    public static AutomationConsoleResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
