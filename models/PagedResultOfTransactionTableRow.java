...
public class PagedResultOfTransactionTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<TransactionTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfTransactionTableRow} and sets the default values.
     */
    public PagedResultOfTransactionTableRow() {
    ...
    public static PagedResultOfTransactionTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfTransactionTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(TransactionTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<TransactionTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<TransactionTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<TransactionTableRow> value) {
        this.items = value;
    }
    /**
