...
public enum InitiateCallRequestSelectionReason implements ValuedEnum {
    ...
    InitiateCallRequestSelectionReason(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static InitiateCallRequestSelectionReason forValue(@jakarta.annotation.Nonnull final String searchValue) {
