...
public enum OrganizationTableRowTenDlcStatus implements ValuedEnum {
    ...
    OrganizationTableRowTenDlcStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationTableRowTenDlcStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
