...
public enum OrganizationTableRowSetupStep implements ValuedEnum {
    ...
    OrganizationTableRowSetupStep(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationTableRowSetupStep forValue(@jakarta.annotation.Nonnull final String searchValue) {
