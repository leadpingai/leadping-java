...
public enum FeedbackType implements ValuedEnum {
    Bug("bug"),
    Confusing("confusing"),
    ...
    FeedbackType(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static FeedbackType forValue(@jakarta.annotation.Nonnull final String searchValue) {
