...
public class BusinessStripeInfoDunning extends BusinessDunningInfo implements Parsable {
     ...
     */
    public BusinessStripeInfoDunning() {
        super();
    }
    /**
    ...
    public static BusinessStripeInfoDunning createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BusinessStripeInfoDunning();
    }
    /**
