...
public class PagedResultOfAutomationTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<AutomationTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfAutomationTableRow} and sets the default values.
     */
    public PagedResultOfAutomationTableRow() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link PagedResultOfAutomationTableRow}
     */
    @jakarta.annotation.Nonnull
    public static PagedResultOfAutomationTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfAutomationTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(AutomationTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<AutomationTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<AutomationTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<AutomationTableRow> value) {
        this.items = value;
    }
    /**
