...
public class BusinessInvitationResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BusinessInvitationResponse} and sets the default values.
     */
    public BusinessInvitationResponse() {
    ...
    public static BusinessInvitationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
