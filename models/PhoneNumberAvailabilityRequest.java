...
public class PhoneNumberAvailabilityRequest implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link PhoneNumberAvailabilityRequest} and sets the default values.
     */
    public PhoneNumberAvailabilityRequest() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link PhoneNumberAvailabilityRequest}
     */
    @jakarta.annotation.Nonnull
    public static PhoneNumberAvailabilityRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
