...
public enum SmsResponseStatus implements ValuedEnum {
    Draft("draft"),
    Scheduled("scheduled"),
    Queued("queued"),
    Sending("sending"),
    ...
    SmsResponseStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static SmsResponseStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
