...
public class PagedResultOfSmsEventTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<SmsEventTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfSmsEventTableRow} and sets the default values.
     */
    ...
    public static PagedResultOfSmsEventTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfSmsEventTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(SmsEventTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<SmsEventTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<SmsEventTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<SmsEventTableRow> value) {
        this.items = value;
    }
    /**
