...
public enum BusinessTableRowSetupStep implements ValuedEnum {
    ...
    BusinessTableRowSetupStep(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static BusinessTableRowSetupStep forValue(@jakarta.annotation.Nonnull final String searchValue) {
