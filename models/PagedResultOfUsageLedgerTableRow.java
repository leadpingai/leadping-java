...
public class PagedResultOfUsageLedgerTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<UsageLedgerTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfUsageLedgerTableRow} and sets the default values.
     */
    public PagedResultOfUsageLedgerTableRow() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link PagedResultOfUsageLedgerTableRow}
     */
    @jakarta.annotation.Nonnull
    public static PagedResultOfUsageLedgerTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfUsageLedgerTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(UsageLedgerTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<UsageLedgerTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<UsageLedgerTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<UsageLedgerTableRow> value) {
        this.items = value;
    }
    /**
