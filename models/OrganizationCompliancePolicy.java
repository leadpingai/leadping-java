...
public class OrganizationCompliancePolicy implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link OrganizationCompliancePolicy} and sets the default values.
     */
    public OrganizationCompliancePolicy() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link OrganizationCompliancePolicy}
     */
    @jakarta.annotation.Nonnull
    public static OrganizationCompliancePolicy createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationCompliancePolicy();
    }
    /**
    ...
    /**
     * Gets the allowedProducts property value. The allowed products included with this organization compliance policy.
    ...
    /**
     * Gets the allowedStates property value. The allowed states included with this organization compliance policy.
     * @return a {@link java.util.List<String>}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the enabled property value. Whether this organization compliance policy is enabled.
    ...
    /**
     * Gets the requireAgentLicenseState property value. Whether this organization compliance policy requires agent license state.
     * @return a {@link Boolean}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the requireLeadState property value. Whether this organization compliance policy requires lead state.
     * @return a {@link Boolean}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the requireProduct property value. Whether this organization compliance policy requires product.
     * @return a {@link Boolean}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the requireSourceComplianceApproval property value. Whether this organization compliance policy requires source compliance approval.
     * @return a {@link Boolean}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the allowedProducts property value. The allowed products included with this organization compliance policy.
    ...
    /**
     * Sets the allowedStates property value. The allowed states included with this organization compliance policy.
    ...
    /**
     * Sets the enabled property value. Whether this organization compliance policy is enabled.
    ...
    /**
     * Sets the requireAgentLicenseState property value. Whether this organization compliance policy requires agent license state.
    ...
    /**
     * Sets the requireLeadState property value. Whether this organization compliance policy requires lead state.
    ...
    /**
     * Sets the requireProduct property value. Whether this organization compliance policy requires product.
    ...
    /**
     * Sets the requireSourceComplianceApproval property value. Whether this organization compliance policy requires source compliance approval.
