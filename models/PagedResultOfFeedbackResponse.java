...
public class PagedResultOfFeedbackResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<FeedbackResponse> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfFeedbackResponse} and sets the default values.
     */
    public PagedResultOfFeedbackResponse() {
    ...
    public static PagedResultOfFeedbackResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfFeedbackResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(FeedbackResponse::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<FeedbackResponse>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<FeedbackResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<FeedbackResponse> value) {
        this.items = value;
    }
    /**
