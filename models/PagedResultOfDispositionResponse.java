...
public class PagedResultOfDispositionResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<DispositionResponse> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfDispositionResponse} and sets the default values.
     */
    public PagedResultOfDispositionResponse() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link PagedResultOfDispositionResponse}
     */
    @jakarta.annotation.Nonnull
    public static PagedResultOfDispositionResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfDispositionResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(DispositionResponse::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<DispositionResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<DispositionResponse> value) {
        this.items = value;
    }
    /**
