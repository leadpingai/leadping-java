...
public class OrganizationMemberResponse implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link OrganizationMemberResponse} and sets the default values.
     */
    ...
    public static OrganizationMemberResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
