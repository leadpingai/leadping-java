...
public enum OrganizationSwitchOptionActivationStatus implements ValuedEnum {
    ...
    OrganizationSwitchOptionActivationStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static OrganizationSwitchOptionActivationStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
