...
public class PhoneLookupCallerName implements AdditionalDataHolder, Parsable {
    /**
    ...
    private String name;
    /**
     * Instantiates a new {@link PhoneLookupCallerName} and sets the default values.
     */
    public PhoneLookupCallerName() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link PhoneLookupCallerName}
     */
    @jakarta.annotation.Nonnull
    public static PhoneLookupCallerName createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
