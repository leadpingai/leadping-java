...
public class TransactionResponse implements AdditionalDataHolder, Parsable {
     ...
     */
    @jakarta.annotation.Nullable
    public TransactionResponseBillableUnit getBillableUnit() {
     ...
     */
    @jakarta.annotation.Nullable
    public TransactionResponseBillingChannel getBillingChannel() {
     ...
     */
    @jakarta.annotation.Nullable
    public TransactionResponseOrganization getOrganization() {
