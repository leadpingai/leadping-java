...
public enum PhoneCallResponseSelectionReason implements ValuedEnum {
    ...
    PhoneCallResponseSelectionReason(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static PhoneCallResponseSelectionReason forValue(@jakarta.annotation.Nonnull final String searchValue) {
