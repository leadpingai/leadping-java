...
public enum BusinessTableRowWebsiteStatus implements ValuedEnum {
    ...
    BusinessTableRowWebsiteStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static BusinessTableRowWebsiteStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
