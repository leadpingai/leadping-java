...
public class PagedResultOfLeadStatusChangeResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<LeadStatusChangeResponse> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfLeadStatusChangeResponse} and sets the default values.
     */
    ...
    public static PagedResultOfLeadStatusChangeResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(LeadStatusChangeResponse::createFromDiscriminatorValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<LeadStatusChangeResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<LeadStatusChangeResponse> value) {
        this.items = value;
    }
    /**
