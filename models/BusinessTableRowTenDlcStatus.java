...
public enum BusinessTableRowTenDlcStatus implements ValuedEnum {
    ...
    BusinessTableRowTenDlcStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static BusinessTableRowTenDlcStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
