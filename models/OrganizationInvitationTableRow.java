...
public class OrganizationInvitationTableRow implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link OrganizationInvitationTableRow} and sets the default values.
     */
    public OrganizationInvitationTableRow() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link OrganizationInvitationTableRow}
     */
    @jakarta.annotation.Nonnull
    public static OrganizationInvitationTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
