...
public class PagedResultOfBusinessTableRow implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<BusinessTableRow> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfBusinessTableRow} and sets the default values.
     */
    public PagedResultOfBusinessTableRow() {
    ...
    public static PagedResultOfBusinessTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfBusinessTableRow();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(BusinessTableRow::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<BusinessTableRow>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<BusinessTableRow> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<BusinessTableRow> value) {
        this.items = value;
    }
    /**
