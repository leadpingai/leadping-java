...
public class OrganizationDunningInfo implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link OrganizationDunningInfo} and sets the default values.
     */
    public OrganizationDunningInfo() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link OrganizationDunningInfo}
     */
    @jakarta.annotation.Nonnull
    public static OrganizationDunningInfo createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new OrganizationDunningInfo();
    }
    /**
    ...
    /**
     * Gets the finalCancellationAt property value. Date and time when this Leadping organization dunning info was final cancellation.
    ...
    /**
     * Gets the gracePeriodEndsAt property value. Date and time when this Leadping organization dunning info was grace period ends.
     * @return a {@link OffsetDateTime}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the lastFailedInvoiceStatus property value. Current last failed invoice status for this Leadping organization dunning info.
    ...
    /**
     * Gets the lastUpdatedAt property value. Date and time when this Leadping organization dunning info was last updated.
     * @return a {@link OffsetDateTime}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the outboundRestrictedAt property value. Date and time when this Leadping organization dunning info was outbound restricted.
     * @return a {@link OffsetDateTime}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the outboundSuspendedAt property value. Date and time when this Leadping organization dunning info was outbound suspended.
     * @return a {@link OffsetDateTime}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Gets the paymentFailedAt property value. Date and time when this Leadping organization dunning info was payment failed.
     * @return a {@link OffsetDateTime}
     */
    @jakarta.annotation.Nullable
    ...
    /**
     * Sets the finalCancellationAt property value. Date and time when this Leadping organization dunning info was final cancellation.
    ...
    /**
     * Sets the gracePeriodEndsAt property value. Date and time when this Leadping organization dunning info was grace period ends.
    ...
    /**
     * Sets the lastFailedInvoiceStatus property value. Current last failed invoice status for this Leadping organization dunning info.
    ...
    /**
     * Sets the lastUpdatedAt property value. Date and time when this Leadping organization dunning info was last updated.
    ...
    /**
     * Sets the outboundRestrictedAt property value. Date and time when this Leadping organization dunning info was outbound restricted.
    ...
    /**
     * Sets the outboundSuspendedAt property value. Date and time when this Leadping organization dunning info was outbound suspended.
    ...
    /**
     * Sets the paymentFailedAt property value. Date and time when this Leadping organization dunning info was payment failed.
    ...
    /**
     * Sets the stage property value. Current stage for this Leadping organization dunning info.
