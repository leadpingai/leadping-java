...
public class PagedResultOfPhoneNumberTableRow implements AdditionalDataHolder, Parsable {
     ...
     */
    public PagedResultOfPhoneNumberTableRow() {
    ...
    public static PagedResultOfPhoneNumberTableRow createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfPhoneNumberTableRow();
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<PhoneNumberTableRow> getItems() {
        return this.items;
    }
    /**
