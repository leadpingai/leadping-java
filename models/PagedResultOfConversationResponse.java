...
public class PagedResultOfConversationResponse implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<ConversationResponse> items;
    /**
    ...
    /**
     * Instantiates a new {@link PagedResultOfConversationResponse} and sets the default values.
     */
    public PagedResultOfConversationResponse() {
    ...
    public static PagedResultOfConversationResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PagedResultOfConversationResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(ConversationResponse::createFromDiscriminatorValue)); });
     ...
     * @return a {@link java.util.List<ConversationResponse>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<ConversationResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    public void setItems(@jakarta.annotation.Nullable final java.util.List<ConversationResponse> value) {
        this.items = value;
    }
    /**
