...
public class PhoneNumberSearchResponse implements AdditionalDataHolder, Parsable {
     ...
     */
    private java.util.List<PhoneNumberSearchResult> numbers;
    /**
     * Instantiates a new {@link PhoneNumberSearchResponse} and sets the default values.
     */
    public PhoneNumberSearchResponse() {
    ...
    public static PhoneNumberSearchResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("numbers", (n) -> { this.setNumbers(n.getCollectionOfObjectValues(PhoneNumberSearchResult::createFromDiscriminatorValue)); });
        return deserializerMap;
    }
    /**
     * Gets the numbers property value. Phone numbers returned or evaluated by this phone number search response.
     * @return a {@link java.util.List<PhoneNumberSearchResult>}
     */
    @jakarta.annotation.Nullable
    public java.util.List<PhoneNumberSearchResult> getNumbers() {
        return this.numbers;
    }
    /**
     ...
     */
    public void setNumbers(@jakarta.annotation.Nullable final java.util.List<PhoneNumberSearchResult> value) {
        this.numbers = value;
    }
}
