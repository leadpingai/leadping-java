...
public enum CustomerActivationStatus implements ValuedEnum {
    ...
    CustomerActivationStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static CustomerActivationStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
