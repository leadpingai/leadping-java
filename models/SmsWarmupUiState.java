...
public class SmsWarmupUiState implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private SmsWarmupHealthState label;
    /**
     * The tone value for this SMS warmup UI state.
     */
    private String tone;
    /**
     * Instantiates a new {@link SmsWarmupUiState} and sets the default values.
     */
    ...
    public static SmsWarmupUiState createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("label", (n) -> { this.setLabel(n.getEnumValue(SmsWarmupHealthState::forValue)); });
     ...
     */
    @jakarta.annotation.Nullable
    public SmsWarmupHealthState getLabel() {
        return this.label;
    }
    /**
     ...
     */
    public void setLabel(@jakarta.annotation.Nullable final SmsWarmupHealthState value) {
        this.label = value;
    }
    /**
