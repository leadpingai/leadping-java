...
public class SuppressionEntryAuditSafeMetadata implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Instantiates a new {@link SuppressionEntryAuditSafeMetadata} and sets the default values.
     */
    public SuppressionEntryAuditSafeMetadata() {
    ...
    public static SuppressionEntryAuditSafeMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SuppressionEntryAuditSafeMetadata();
    }
    /**
