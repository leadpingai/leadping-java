...
public enum BusinessSwitchOptionTenDlcStatus implements ValuedEnum {
    ...
    BusinessSwitchOptionTenDlcStatus(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static BusinessSwitchOptionTenDlcStatus forValue(@jakarta.annotation.Nonnull final String searchValue) {
