...
public class IdNamePair implements AdditionalDataHolder, Parsable {
    ...
    private String name;
    /**
     * Instantiates a new {@link IdNamePair} and sets the default values.
     */
    public IdNamePair() {
    ...
    public static IdNamePair createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
