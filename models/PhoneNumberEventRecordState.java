...
public enum PhoneNumberEventRecordState implements ValuedEnum {
    Available("Available"),
    Assigned("Assigned"),
    ...
    PhoneNumberEventRecordState(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static PhoneNumberEventRecordState forValue(@jakarta.annotation.Nonnull final String searchValue) {
