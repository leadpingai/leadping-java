...
public enum PhoneNumberReadinessCallStage implements ValuedEnum {
    ...
    PhoneNumberReadinessCallStage(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static PhoneNumberReadinessCallStage forValue(@jakarta.annotation.Nonnull final String searchValue) {
