package ai.leadping.openapi.organizations.apikeys;

import ai.leadping.openapi.organizations.apikeys.item.ApiKeysItemRequestBuilder;
import ai.leadping.openapi.organizations.apikeys.my.MyRequestBuilder;
...
public class ApiKeysRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @jakarta.annotation.Nonnull
    public ApiKeysItemRequestBuilder byId(@jakarta.annotation.Nonnull final String id) {
        Objects.requireNonNull(id);
        final HashMap<String, Object> urlTplParams = new HashMap<String, Object>(this.pathParameters);
        urlTplParams.put("id", id);
        return new ApiKeysItemRequestBuilder(urlTplParams, requestAdapter);
    }
    /**
    ...
    public ApiKeysRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/api-keys", pathParameters);
    }
    /**
     * Instantiates a new {@link ApiKeysRequestBuilder} and sets the default values.
    ...
    public ApiKeysRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/api-keys", rawUrl);
    }
}
