package ai.leadping.openapi.organizations.me.onezerodlc.notes;
...
public class NotesRequestBuilder extends BaseRequestBuilder {
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/me/10dlc/notes", pathParameters);
    }
    /**
     * Instantiates a new {@link NotesRequestBuilder} and sets the default values.
    ...
    public NotesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/me/10dlc/notes", rawUrl);
    }
    /**
    ...
    public OrganizationResponse put(@jakarta.annotation.Nonnull final TenDlcNotesRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationResponse put(@jakarta.annotation.Nonnull final TenDlcNotesRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
