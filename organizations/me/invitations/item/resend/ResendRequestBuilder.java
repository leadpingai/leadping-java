package ai.leadping.openapi.organizations.me.invitations.item.resend;
...
public class ResendRequestBuilder extends BaseRequestBuilder {
    ...
    public ResendRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/me/invitations/{invitationId}/resend", pathParameters);
    }
    /**
     * Instantiates a new {@link ResendRequestBuilder} and sets the default values.
    ...
    public ResendRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/me/invitations/{invitationId}/resend", rawUrl);
    }
    /**
    ...
    public OrganizationInvitationResponse post() {
        return post(null);
    }
    /**
     * Resends a pending current-organization invitation, refreshing delivery while preserving recipient, role, and acceptance token.
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationInvitationResponse post(@jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
