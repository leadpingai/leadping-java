package ai.leadping.openapi.organizations.invitations.token.item;
...
public class WithTokenItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithTokenItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/invitations/token/{token}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithTokenItemRequestBuilder} and sets the default values.
    ...
    public WithTokenItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/invitations/token/{token}", rawUrl);
    }
    /**
    ...
    public OrganizationInvitationResponse get() {
        return get(null);
    }
    /**
     * Returns an organization invitation by acceptance token, including organization, recipient, role, and expiration details.
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationInvitationResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
