package ai.leadping.openapi.leads.all.my;

import ai.leadping.openapi.models.PagedResultOfLeadTableRow;
...
public class MyRequestBuilder extends BaseRequestBuilder {
    ...
    public MyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leads/all/my{?archiveFilter*,tagIds*,tagMatchAll*,untagged*}", pathParameters);
    }
    /**
     * Instantiates a new {@link MyRequestBuilder} and sets the default values.
    ...
    public MyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/leads/all/my{?archiveFilter*,tagIds*,tagMatchAll*,untagged*}", rawUrl);
    }
    /**
    ...
    public PagedResultOfLeadTableRow post(@jakarta.annotation.Nonnull final RequestDataOptions body) {
     ...
     */
    @jakarta.annotation.Nullable
    public PagedResultOfLeadTableRow post(@jakarta.annotation.Nonnull final RequestDataOptions body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = toPostRequestInformation(body, requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("401", ProblemDetails::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, PagedResultOfLeadTableRow::createFromDiscriminatorValue);
    }
    /**
     * Lists leads visible to the current user with paging, sorting, filters, tags, and archive status for pipeline review.
     * @param body Options for flexible, efficient, and explicit querying in Cosmos DB or similar repositories.
    ...
    public class PostQueryParameters implements QueryParameters {
        ...
        public Map<String, Object> toQueryParameters() {
            ...
            allQueryParams.put("archiveFilter", archiveFilter);
            allQueryParams.put("tagMatchAll", tagMatchAll);
            allQueryParams.put("untagged", untagged);
