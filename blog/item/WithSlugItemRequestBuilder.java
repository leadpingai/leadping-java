package ai.leadping.openapi.blog.item;
...
public class WithSlugItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithSlugItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/blog/{slug}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithSlugItemRequestBuilder} and sets the default values.
    ...
    public WithSlugItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/blog/{slug}", rawUrl);
    }
    /**
    ...
    public BlogArticleResponse get() {
        return get(null);
    }
    /**
     * Returns the public article identified by its URL slug, or a not-found response when no published article matches.
     ...
     */
    @jakarta.annotation.Nullable
    public BlogArticleResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("404", ProblemDetails::createFromDiscriminatorValue);
        errorMapping.put("429", ProblemDetails::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, BlogArticleResponse::createFromDiscriminatorValue);
    }
    /**
     * Returns the public article identified by its URL slug, or a not-found response when no published article matches.
